...
lv_obj_t * ui_MainMenuItem = NULL;
lv_obj_t * ui_MainMenuHint = NULL;
// event funtions
...
void ui_MainMenu_screen_init(void)
{
    ...
    lv_obj_set_style_bg_img_src(ui_MainMenu, &ui_img_2092402157, LV_PART_MAIN | LV_STATE_DEFAULT);
...
void ui_MainMenu_screen_destroy(void)
{
    ...
    ui_MainMenu = NULL;
    ui_MainMenuItem = NULL;
    ui_MainMenuHint = NULL;

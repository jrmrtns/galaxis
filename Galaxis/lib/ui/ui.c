...
///////////////////// VARIABLES ////////////////////
lv_anim_t * search_anim_Animation(lv_obj_t * TargetObject, int delay);
...
void ui_destroy(void)
{
    ...
    ui_Game_screen_destroy();
    ui_GameOver_screen_destroy();
    ui_Settings_screen_destroy();
    ui_HideShips_screen_destroy();
}
